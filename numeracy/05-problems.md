...
{% include question_numerical.html
    ...
    question_text="A UK business buys a machine from the USA for $\text{$}6,000$ (USD). <br> The exchange rate is $£1 = \text{$}1.25$. <br> The shipping company charges a flat fee of £200. <br> What is the total cost in Pounds Sterling (£)?"
    correct_answer="5000"
    tolerance="0.01"
